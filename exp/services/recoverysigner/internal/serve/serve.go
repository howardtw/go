...
func getHandlerDeps(opts Options) (handlerDeps, error) {
	...
	encrypter, decrypter, err := crypto.NewEncrypterDecrypter(opts.Logger, opts.EncryptionKMSKeyURI, opts.EncryptionTinkKeysetPrivateJSON, opts.EncryptionTinkKeysetPublicJSON)
	if err != nil {
